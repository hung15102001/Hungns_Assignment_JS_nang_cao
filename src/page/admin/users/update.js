              ...
              <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <div class="grid grid-cols-3 gap-6">
                    <div class="col-span-3 sm:col-span-2">
                      ...
                      <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input type="text" name="email" id="email" class="py-2 focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="abc@gmail.com" value="${data.email}" disabled>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="mt-1">
                      <input id="name" name="name" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Nguyễn văn A" value="${data.name}" disabled></input>
                    </div>
                ...
                <div>
                  <label for="about" class="block text-sm font-medium text-gray-700">Password new</label>
                  <div class="mt-1">
                    <input id="password" name="password" type="password" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="*********"></input>
                  </div>
                  <p class="mt-2 text-sm text-gray-500">Brief description for your profile. URLs are hyperlinked.</p>
      ...
      formAddUser.addEventListener("submit", async (e) => {
          ...
          try{
            edit({
             ...
             if(data){
              toastr.success("Cập nhật thành công chuyển sau 2s");
              setTimeout(() => {
