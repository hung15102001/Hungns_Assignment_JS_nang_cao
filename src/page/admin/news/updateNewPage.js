              ...
              <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <div class="grid grid-cols-3 gap-6">
                    <div class="col-span-3 sm:col-span-2">
                      ...
                      <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input type="text" name="email" id="email" class="py-2 focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="abc" value="">
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="mt-1">
                      <input id="name" name="name" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Nguyễn văn A" value=""></input>
                    </div>
